...
public class Main_1_2_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("ASCII Value 74 is: " + c); // Output: ASCII Value 74 is: J
		...
		System.out.println("Float 1: " + fl1); // Output: Float 1: 3.5E9
		System.out.println("Double 1: " + do1); // Output: Double 1: 3.5E9
		...
		System.out.printf("Float 2: " + "%.5f", f1); // Output: Float 2: 16.66667
		System.out.println("");
		System.out.print("Double 2: "); // Output: Doule 2: 33
