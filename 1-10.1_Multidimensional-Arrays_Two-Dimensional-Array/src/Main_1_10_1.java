...
public class Main_1_10_1 {
	...
	public static void main(String[] args) {
		...
		// 3, 1, and 2 are a part of teams array 2
		
		// In array 1, we have named 3 different teams. In array 2, we have number of people on that team
		...
		System.out.println(teams[0][1] + ": " + teams[1][1]);
